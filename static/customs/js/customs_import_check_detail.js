...
$(function(){
    ...
    collect_tax_btn.click(function(event){
        ...
        rhjajax.post({
            url:'/customs/import_collect_tax/',
            data:{
            ...
            success:function(data){
                if(data['code']==200){
                    ...
                    setTimeout(function(){
                        window.location='/customs/customs_import_check/1/0/5/1/';
                    },1200)
                }else{
...
$(function(){
    ...
    check_btn.click(function(event){
        ...
        rhjajax.post({
            url:'/customs/import_check_commodity/',
            data:{
                declaration_uuid:declaration_uuid,
                declaration_model:declaration_model,
            },
...
$(function(){
    var success_btn=$('#success_btn');
        ...
        rhjajax.post({
            url:'/customs/import_check_success/',
            data:{
                declaration_model:declaration_model,
                declaration_uuid:declaration_uuid,
            },
