/**
 * Created by rhj231223 on 2017/12/4.
 */
...
$(function(){
    ...
    socket.on('connect',function(){
        ...
        if(model=='Employee'){
            self_group=['Employee__none','Customs_User__none','Front_User__none'];
        }else{
            self_group=[model+'__none']
        }


        window.sender=self_room;
        window.group=self_group;



        var data={'self_room':self_room,'self_group':self_group};
